...
# Add this in StoX 4.0.0: # @param BootstrapNetCDF4Data The \code{\link{BootstrapNetCDF4Data}} data.
#' @param ReportBootstrapData The \code{\link{ReportBootstrapData}} data.
# Add this in StoX 4.0.0: #' @param ReportBootstrapNetCDF4Data The \code{\link{ReportBootstrapNetCDF4Data}} data.
...
#' 
#' @seealso This data type is produced by the function \code{\link{Bootstrap}}. See \code{\link{DataTypes}} for a list of all data types produced by \code{\link{RstoxData}}, \code{\link{RstoxBase}} and \code{\link{RstoxFramework}}.
#' 
#' @name BootstrapData
#' 
NULL
...
### ##################################################
### ##################################################
### #' BootstrapNetCDF4 data
### #' 
### #' The BootstrapNetCDF4Data model data is the path to a NetCDF4 memory file holding the outputs from the baseline generated by re-running baseline with random ### sampling of the PSUs and assignments (in the case of acoustic-trawl estimates).
### #' 
### #' @seealso This data type is produced by the function \code{\link{BootstrapNetCDF4}}. See \code{\link{DataTypes}} for a list of all data types produced by ### \code{\link{RstoxData}}, \code{\link{RstoxBase}} and \code{\link{RstoxFramework}}.
### #' 
### #' @name BootstrapNetCDF4Data
### #' 
### NULL
...
### ##################################################
### ##################################################
### #' Reported BootstrapNetCDF4 data
### #' 
### #' The ReportBootstrapNetCDF4Data model data is a report of the \code{\link{BootstrapNetCDF4Data}} such as cv of Biomass per Stratum and SpeciesCategory, given as a ### table or list of tables.
### #' 
### #' @seealso This data type is produced by \code{\link{ReportBootstrapNetCDF4}}. See \code{\link{DataTypes}} for a list of all StoX data types produced by ### \code{\link{RstoxData}}, \code{\link{RstoxBase}} and \code{\link{RstoxFramework}}.
### #' 
### #' @name ReportBootstrapNetCDF4Data
### #' 
### NULL
