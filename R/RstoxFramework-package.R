...
utils::globalVariables(c(
	 ...
	 "..propertyDirty", "..skipNAAt", "..stationInfoToKeep", "..validInd", "AcoCat", "BeamKey",
	 "BootstrapID", "CruiseKey", "EDSU", "Haul", "JavaJEXL2R", "Latitude", "Latitude2", "Layer",
	 "LogKey", "LogOrigin", "LogOrigin2", "Longitude", "Longitude2", "PSU", "Package", "PolygonKey",
