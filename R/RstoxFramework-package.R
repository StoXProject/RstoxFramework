...
utils::globalVariables(c(
	 ...
	 "..functionParameters", "..haulInfoToKeep", "..newProcessName", "..presentVariables",
	 "..processDirty", "..propertyDirty", "..signifDigits", "..skipNAAt", "..stationInfoToKeep",
	 "..subsetByNAOn_New", "..subsetByNAOn_Old", "..temporaryScaleFromResampling", "..validInd",
