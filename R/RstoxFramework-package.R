...
utils::globalVariables(c(
	 ...
	 "..functionParameters", "..haulInfoToKeep", "..ind", "..newProcessName", "..presentVariables",
	 "..processDirty", "..propertyDirty", "..skipNAAt", "..stationInfoToKeep", "..validInd",
	 "AcoCat", "BeamKey", "BootstrapID", "CruiseKey", "EDSU", "Haul", "JavaJEXL2R", "Latitude",
	 "Latitude2", "Layer", "LogKey", "LogOrigin", "LogOrigin2", "Longitude", "Longitude2", "PSU",
	 "Package", "PolygonKey", "ProcessName", "ResampleFunction", "SampleUnit", "Station",
	 "StationWeight", "StoX", "Stratum", "Version", "WeightingFactor", "assignmentPasted",
	 "attriributes<-", "baselineTable", "binaryPath", "canShowInMap", "capture.output", "ch",
	 "col2rgb", "colorRampPalette", "dataTable2SpatialPolygonsDataFrame", "dataType",
	 "download.file", "freq", "functionName", "functionOutputDataType", "hasProcessData",
	 "install.packages", "model", "modelName", "models", "name", "newVersion", "numStations",
	 "possibleValues", "processID", "processIndex", "processName", "processNames", "projectList",
	 "projectList2.7", "projectPath", "projectPath2.7", "read.table", "remove.packages",
	 "resampledCountWithUniqueName", "start_time", "transceiver", "value", "weightsPasted"))
