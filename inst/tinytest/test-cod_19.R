...
expect_true("ReportBootstrap_Abundance.ReportBootstrapData" %in% names(d$test$data_equal))
...
oldStratumArea <- data.table::as.data.table(read.table(unz(projectPaths, "cod_19/output/baseline/StratumArea/StratumAreaData.txt"), sep = "\t", header = TRUE))
